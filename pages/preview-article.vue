  ...
  <div class="w-full min-h-screen bg-white">
    <div class="pt-[48px] px-[160px]">
      <img
        ...
        @click="$router.push('dashboard/article')"
      />
      <div class="mt-[32px]">
        <img
          src="/images/product/dimsum-article.png"
          alt="dimsum"
          class="w-[1120px] h-[380px]"
        />
        <section class="grid grid-cols-3 mt-[32px] gap-x-[64px]">
          <h1 class="text-[40px] font-bold text-[#2D2D2D] col-span-3">
            Apa Manfaat Dimsum Untuk <br />
            Tubuh?
          </h1>
          <div class="col-span-2">
            ...
            >
              ...
              <p>Senin, 20 April 2023 - 13.05 WIB</p>
            ...
            <div class="text-[#717171] text-base text-justify space-y-[16px]">
              <p>
                Mungkin sudah banyak yang tahu Dimsum merupakan salah satu
                kudupan khas Tiongkok, Cina. Namun, apakah kalian tahu apa saja
                manfaat dari makanan ini? ada beberapa manfaat luar biasa.
                Penasaran? Saatnya simak ulasan di bawah ini!
              </p>
              <p class="pl-[10px]">1. Membantu Menguatkan Tulang</p>
              <p>
                Dimsum terdiri dari isian yang bervariasi, salah satunya udang.
                Tahukah kalian, bahwa udang kaya akan kandungan fosfor yang
                sangat dibutuhkan tubuh. Fosfor dan kalium di dalam tubuh
                membantu dalam proses pembentukan tulang dan gigi. Sementara,
                pada kulit udang mengandung zat "glucosamine" yang berfungsi
                dalam pembentukan tulang rawan di persendian tulang.
              </p>
              <p class="pl-[10px]">2. Membantu Menguatkan Tulang</p>
              <p>
                Dimsum terdiri dari isian yang bervariasi, salah satunya udang.
                Tahukah kalian, bahwa udang kaya akan kandungan fosfor yang
                sangat dibutuhkan tubuh. Fosfor dan kalium di dalam tubuh
              ...
              <p class="pl-[10px]">3.Membantu Menguatkan Tulang</p>
              <p>
                Dimsum terdiri dari isian yang bervariasi, salah satunya udang.
                Tahukah kalian, bahwa udang kaya akan kandungan fosfor yang
                sangat dibutuhkan tubuh. Fosfor dan kalium di dalam tubuh
...
<script>
import TopArticle from "~/components/article/top-article.vue";
export default {
  components: {
    TopArticle,
  },
